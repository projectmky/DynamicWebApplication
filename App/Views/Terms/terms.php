    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#Hyperlink" tabindex="-1" aria-disabled="true">Hyperlinks to
                        our content</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#iFrames" tabindex="-1" aria-disabled="true">iFrames</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#ContentLiability" tabindex="-1" aria-disabled="true">Content
                        Liability</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#Privacy" tabindex="-1" aria-disabled="true">Your Privacy
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#Disclaimer" tabindex="-1" aria-disabled="true">Disclaimer
                    </a>
                </li>
...
<!-- <ul class="menu">
    ...
    <li><a href="#License">
            License</a></li>
    <li><a href="#Hyperlink">
            Hyperlinks to our content</a></li>
    <li><a href="#iFrames">
            iFrames</a></li>
    <li><a href="#ContentLiability">
            Contetnt Liability</a></li>
    <li><a href="#Privacy">
            Your Privacy</a></li>
