...
<body>
  ...
  <div id="demo" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
      ...
      <!-- <div class="carousel-item" style="background-image: url(../images/socar-post.jpg);">
        <div class="container">
          <h4>
            Want to post your car? Create a listing here
          </h4>
          <a href="Lisitngs/listing" class="btn btn-primary">Create a Listing</a>
        </div>
      </div> -->
